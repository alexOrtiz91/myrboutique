...
function Card({ to, title, subtitle }) {
  return (
    ...
    >
      ...
      <div className="mt-1 text-base font-medium text-slate-600">{subtitle}</div>
    </Link>
  )
}
  ...
  return (
    <div className="space-y-5">
      <section className="rounded-2xl bg-slate-900 p-6 text-white">
        <div className="text-2xl font-extrabold tracking-tight">Prototipo de inventario + ventas</div>
        <div className="mt-2 text-base font-medium text-slate-200">
          Sin autenticación ni backend real. Enfocado en UX táctil y flujo de escaneo.
        </div>
      </section>
